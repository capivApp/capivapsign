...
export const OrganisationMemberInviteDialog = ({ trigger, ...props }: OrganisationMemberInviteDialogProps) => {
  ...
  const downloadTemplate = () => {
    const data = [
      { email: 'admin@capivapp.com.br', role: 'Admin' },
      { email: 'manager@capivapp.com.br', role: 'Manager' },
      { email: 'member@capivapp.com.br', role: 'Member' },
    ];
    ...
    downloadFile({
      filename: 'capivasign-organisation-member-invites-template.csv',
      data: blob,
    });
  };
