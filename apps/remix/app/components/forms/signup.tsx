...
import { UserProfileTeaser } from '~/components/general/user-profile-teaser';
      ...
      <div className="relative hidden flex-1 overflow-hidden rounded-xl border border-border xl:flex">
        ...
        <div className="relative flex h-full w-full flex-col items-center justify-evenly">
          ...
          <div className="w-full max-w-md">
            <UserProfileTeaser rows={2} className="rounded-2xl border border-border bg-background shadow-md" />
          </div>
      ...
      <div className="relative z-10 flex min-h-[min(850px,80vh)] w-full max-w-lg flex-col rounded-xl border border-border bg-neutral-100 p-6 dark:bg-background">
            ...
            <fieldset className="flex w-full flex-col gap-y-4" disabled={isSubmitting}>
              ...
              <p className="mt-4 text-muted-foreground text-sm">
                <Trans>
                  ...
                  <Link to="/signin" className="text-brand-700 duration-200 hover:opacity-70">
                    Sign in instead
                  </Link>
                </Trans>
              </p>
        ...
        <p className="mt-6 text-muted-foreground text-xs">
          <Trans>
            ...
            <Link
              to="https://capivapp.com.br/terms"
              target="_blank"
            ...
            and{' '}
            <Link
              to="https://capivapp.com.br/privacy"
              target="_blank"
              className="text-brand-700 duration-200 hover:opacity-70"
            >
              Privacy Policy
