 ...
 * `.capivasign-branded` wrapper rendered in `_recipient+/_layout.tsx`.
 *
 ...
 *   }
 *
 * Equivalent to `.capivasign-branded .my-class { color: red; }` after expansion.
 *
...
export const RecipientBranding = ({ branding, cspNonce }: RecipientBrandingProps) => {
  ...
  const css = `.capivasign-branded { ${innerBody} }`;
