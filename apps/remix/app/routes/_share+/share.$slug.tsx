...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'CapivaSign - Share' },
    { description: 'I just signed a document in style with CapivaSign!' },
    {
      property: 'og:title',
      content: 'CapivaSign - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with CapivaSign!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for CapivaSign.
  throw redirect('https://capivapp.com.br');
};
