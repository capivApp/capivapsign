  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using CapivaSign to perform your electronic document signing. The purpose of this disclosure
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by CapivaSign, you affirm that you have read
