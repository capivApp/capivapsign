...
description: Use the demo environment to try out the CapivaSign platform and its features.
---
...
You can use it to try out the CapivaSign platform and its features before committing to a paid plan.
...
<Steps>
  <Step>
    ...
    Go to the [staging environment](https://stg-app.capivapp.com.br).
  ...
  <Step>
    ...
    If you have any issues, questions or feedback, please reach out to us on the [CapivaSign Discord](https://documen.so/discord) or [GitHub](https://github.com/capivapp/capiva-sign/issues).
