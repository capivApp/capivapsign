...
description: Learn how to contribute translations to CapivaSign and become part of our community.
---
...
We store our translations in PO files, which are located in our GitHub repository [here](https://github.com/capivapp/capiva-sign/tree/main/packages/lib/translations).
...
msgid "Want to send slick signing links like this one? <0>Check out CapivaSign.</0>"
msgstr "Möchten Sie auffällige Signatur-Links wie diesen senden? <0>Überprüfen Sie CapivaSign.</0>"
```
...
Thank you for helping make CapivaSign more accessible to users around the world!
