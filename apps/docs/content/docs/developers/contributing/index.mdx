---
title: Contributing to CapivaSign
description: Learn how to contribute to CapivaSign and become part of our community.
---
...
This guide will help you get started with contributing to CapivaSign.
...
Search the existing [issues](https://github.com/capivapp/capiva-sign/issues) to see if someone else reported the same issue. Or, check the [existing PRs](https://github.com/capivapp/capiva-sign/pulls) to see if someone else is already working on the same thing.
...
- [Contributing Translations](/docs/developers/contributing/contributing-translations) - Help translate CapivaSign
