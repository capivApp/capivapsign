...
description: Integrate CapivaSign into your applications using the REST API, webhooks, and embedding options.
---
...
```
https://app.capivapp.com.br/api/v2
```
...
<Cards>
  ...
  <Card
    title="Self-Hosting"
    description="Deploy your own CapivaSign instance."
