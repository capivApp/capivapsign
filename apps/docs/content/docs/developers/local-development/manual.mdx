---
title: Manual Setup
description: Manually set up CapivaSign on your machine for local development.
---
...
Follow these steps to set up CapivaSign on your local machine:
...
Fork the [CapivaSign repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
```bash
git clone https://github.com/<your-username>/capivasign
```
...
Access the CapivaSign application by visiting `http://localhost:3000` in your web browser.
