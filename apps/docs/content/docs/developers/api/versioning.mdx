...
description: Versioning information for the CapivaSign public API.
---
...
CapivaSign uses API versioning to manage changes to the public API. This allows us to introduce new features, fix bugs, and make other changes without breaking existing integrations.

<Callout type="info">The current version of the API is `v2`.</Callout>

The API version is specified in the URL. For example, the base URL for the `v2` API is `https://app.capivapp.com.br/api/v2`.
