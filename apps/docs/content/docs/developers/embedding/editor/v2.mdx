...
| `host`           | `string`  | No       | Custom host URL. Defaults to `https://app.capivapp.com.br` |
...
| `language`       | `string`  | No       | Set the UI language. See [Supported Languages](https://github.com/capivapp/capiva-sign/tree/main/packages/lib/constants/locales.ts) |
