...
In addition to embedding signing, CapivaSign supports embedded editor. It allows your users to create and edit documents, templates, and envelopes without leaving your application.
...
This endpoint requires your CapivaSign API key. The token has a default expiration of 1 hour.

See the [API documentation](https://openapi.capivapp.com.br/reference#tag/embedding) for full details.
