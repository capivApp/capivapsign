...
CapivaSign offers two types of embedding:
...
- Dark mode controls
- Removal of CapivaSign branding
...
<Steps>
<Step>
Navigate to your team's templates in CapivaSign
...
For example, `https://app.capivapp.com.br/d/-WoSwWVT-fYOERS2MI37k` has the token `-WoSwWVT-fYOERS2MI37k`.
...
| `host`                | `string`   | CapivaSign instance URL. Defaults to `https://app.capivapp.com.br`. |
...
| `language`            | `string`   | Set the UI language. See [Supported Languages](https://github.com/capivapp/capiva-sign/tree/main/packages/lib/constants/locales.ts). |
