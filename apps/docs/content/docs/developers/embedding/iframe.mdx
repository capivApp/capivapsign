...
```html
<iframe
  src="https://app.capivapp.com.br/embed/sign/abc123xyz"
  width="100%"
  height="800"
  frameborder="0"
...
<Callout title="Use the correct embed URL">
  ...
  embed URL provided by CapivaSign for your flow.
</Callout>
...
CapivaSign expects the fragment to be **base64** of:
...
A complete example can be found in the [Embeds repository](https://github.com/capivasign/embeds/blob/main/packages/mitosis/src/sign-document.lite.tsx).
