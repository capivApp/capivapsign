...
- A CapivaSign account on any plan (Free, Individual, Team, or Enterprise)
...
- Log in to your CapivaSign account
- Click your avatar in the top right corner
- Select **Settings** from the dropdown menu

![User dropdown menu](/public-api-images/capivasign-user-dropdown-menu.webp)
...
![API tokens page](/public-api-images/api-tokens-page-capivasign.webp)
...
![API key display](/public-api-images/capivasign-api-key-blurred.webp)
...
```bash
curl https://app.capivapp.com.br/api/v2/document \
...
CapivaSign provides official SDKs that handle authentication for you:

```typescript
import { CapivaSign } from '@documenso/sdk-typescript';

const client = new CapivaSign({
...
SDKs are available for [TypeScript](https://github.com/capivasign/sdk-typescript), [Python](https://github.com/capivasign/sdk-python), and [Go](https://github.com/capivasign/sdk-go).
...
<Callout type="info">
  ...
  OpenAPI reference](https://app.capivapp.com.br/api/v1/openapi).
</Callout>
