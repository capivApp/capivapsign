...
description: Create and send a document for signing using the CapivaSign API, from uploading a PDF to adding recipients and distributing for signature.
---
...
- A CapivaSign account (cloud or self-hosted)
...
| ----------- | -------------------------------------- |
| Production  | `https://app.capivapp.com.br/api/v2`     |
| Staging     | `https://stg-app.capivapp.com.br/api/v2` |
...
```javascript
const response = await fetch('https://app.capivapp.com.br/api/v2/envelope', {
  method: 'GET',
  headers: {
...
<Tab value="curl">
```bash
curl -X POST "https://app.capivapp.com.br/api/v2/envelope/envelope_abc123/distribute" \
  -H "Authorization: YOUR_API_TOKEN" \
...
const response = await fetch(
  `https://app.capivapp.com.br/api/v2/envelope/${envelopeId}/distribute`,
  {
    method: 'POST',
    headers: {
      Authorization: 'YOUR_API_TOKEN',
...
- [API Reference](https://openapi.capivapp.com.br/) - Full endpoint documentation with request/response schemas
...
- [TypeScript SDK](https://github.com/capivasign/sdk-typescript)
- [Python SDK](https://github.com/capivasign/sdk-python)
- [Go SDK](https://github.com/capivasign/sdk-go)
