...
<Callout type="info">
  CapivaSign seals all signed documents cryptographically, regardless of signature level, to prevent
...
<Callout type="warn">
  Status: [Planned](https://github.com/capivasign/backlog/issues/9) via third party until [Let's
  Sign](https://github.com/capivasign/backlog/issues/21) is realized.
</Callout>
...
<Callout type="warn">
  Status: [Planned](https://github.com/capivasign/backlog/issues/32) via third party until [Let's
  Sign](https://github.com/capivasign/backlog/issues/21) is realized.
</Callout>
...
## What CapivaSign Provides

CapivaSign supports Simple Electronic Signatures (SES) with features that enhance evidentiary value:
...
### What CapivaSign Does Not Provide
...
<Callout type="warn">Status: [Planned](https://github.com/capivasign/backlog/issues/34)</Callout>
