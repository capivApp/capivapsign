---
title: GDPR
description: Understand how CapivaSign handles GDPR compliance for data processing and storage.
---
...
When using CapivaSign for document signing, two distinct data processing roles apply:

| Role                | Description                                                                           |
| ------------------- | ------------------------------------------------------------------------------------- |
| **Data Controller** | You (the organisation using CapivaSign) determine the purposes and means of processing |
| **Data Processor**  | CapivaSign processes personal data on your behalf according to your instructions       |
...
As the data processor, CapivaSign:
...
CapivaSign processes personal data necessary to provide document signing services:
...
Where your data is stored depends on how you use CapivaSign:

<Tabs items={['CapivaSign Cloud', 'Self-Hosted']}>
<Tab value="CapivaSign Cloud">
...
Contact CapivaSign for specific information about sub-processors and data centre locations.

</Tab>
<Tab value="Self-Hosted">

When you self-host CapivaSign:

- You control all data storage locations
- No data is transmitted to CapivaSign's infrastructure
...
- Export user and document data from your CapivaSign account
- Delete user accounts and associated documents
- Contact CapivaSign support for assistance with cloud-hosted data

## Data Deletion

CapivaSign supports data deletion to help fulfill erasure requests:
...
Self-hosting CapivaSign can simplify GDPR compliance:
...
- Contact [support@capivapp.com.br](mailto:support@capivapp.com.br) to request a DPA
- The DPA covers CapivaSign's obligations as a data processor

</Tab>
<Tab value="Self-Hosted">

No DPA with CapivaSign is required since no personal data is processed by CapivaSign.
...
This documentation is provided for informational purposes only and does not constitute legal advice. GDPR compliance depends on your specific circumstances, including how you use CapivaSign, what data you process, and your organisation's obligations.
...
- [Self-Hosting Guide](/docs/self-hosting) - Deploy CapivaSign on your own infrastructure
