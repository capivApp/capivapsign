...
description: CapivaSign's compliance status for industry certifications and regulatory frameworks.
---
...
Read more about [21 CFR Part 11 with CapivaSign](https://documen.so/21-CFR-Part-11).
...
<Callout type="warn">Status: [Planned](https://github.com/capivasign/backlog/issues/26)</Callout>
