...
description: The open-source version of CapivaSign, available under the AGPL-3.0 license. Includes core document signing functionality and can be self-hosted.
---
...
The full license text is available in the [LICENSE file](https://github.com/capivapp/capiva-sign/blob/main/LICENSE) in the repository.
...
| Action             | Description                                                   |
| ------------------ | ------------------------------------------------------------- |
| **Use**            | Run CapivaSign for any purpose, including commercial use       |
...
<Accordions type="multiple">
  <Accordion title="Source Code Disclosure">
    If you modify CapivaSign and make it available over a network, you must:
    ...
    <Callout type="warn">
      ...
      CapivaSign instance over a network (whether internal or external), you must provide them access to
      the source code.
    </Callout>
  ...
  <Accordion title="License Continuity">
    ...
    - Combined works that incorporate CapivaSign code are subject to AGPL-3.0
...
The Community Edition includes the core CapivaSign functionality:
...
<Accordions type="multiple">
  <Accordion title="Discord">
    The CapivaSign Discord server is the primary community support channel. You can:
  ...
  <Accordion title="GitHub">
    - **[GitHub Discussions](https://github.com/capivapp/capiva-sign/discussions)**: For questions, ideas, and general discussion
    - **[GitHub Issues](https://github.com/capivapp/capiva-sign/issues)**: For confirmed bug reports with reproducible steps
  </Accordion>
...
<Callout type="info">
  Community support is provided on a best-effort basis by volunteers and CapivaSign team members. For
  guaranteed response times and dedicated support, consider the Enterprise Edition.
</Callout>

## Contributing Back

Contributions to CapivaSign are welcome and appreciated. You can contribute in several ways:

<Accordions type="multiple">
  <Accordion title="Code Contributions">
    1. Fork the [CapivaSign repository](https://github.com/capivapp/capiva-sign)
  ...
  <Accordion title="Contributor Guidelines">
    ...
    - The [CONTRIBUTING.md](https://github.com/capivapp/capiva-sign/blob/main/CONTRIBUTING.md) file in the repository
