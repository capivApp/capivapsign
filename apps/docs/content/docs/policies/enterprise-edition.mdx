...
description: Commercial license that removes AGPL-3.0 source code disclosure requirements, allowing organisations to integrate CapivaSign into proprietary products.
---
...
- **Build proprietary products**: Integrate CapivaSign into commercial software without releasing source code
...
- **Need to keep modifications private**: Any changes to CapivaSign source code that you don't want to disclose

<Callout type="info">
  If you run CapivaSign without modifications, or your modifications are open source under AGPL-3.0,
...
| SaaS product using CapivaSign API only        | Community Edition  |
| SaaS product with modified CapivaSign code    | Enterprise Edition |
...
<Accordions type="multiple">
  <Accordion title="License Rights">
    ...
    - **Proprietary integration**: Embed CapivaSign in closed-source products without licensing conflicts.
    - **Sublicensing options**: Distribute CapivaSign as part of your product to your customers (terms vary by agreement).
  ...
  <Accordion title="License Setup">
    ...
    2. Access your license key at [license.capivapp.com.br](https://license.capivapp.com.br)
    3. Set the environment variable:

    ```bash
    NEXT_PRIVATE_LICENSE_KEY="your-license-key-here"
    ```

    4. Restart your CapivaSign instance
...
<Accordions type="multiple">
  <Accordion title="Grant of License">
    The Enterprise license is a commercial agreement between your organisation and CapivaSign. Key terms include:

    - **Scope**: License to use, modify, and distribute CapivaSign as specified in your agreement
    - **Exclusions**: The license does not grant rights to CapivaSign trademarks beyond what's specified
  ...
  <Accordion title="What the License Does Not Cover">
    ...
    - CapivaSign Cloud service (separate subscription)
...
| Factor              | Description                         |
| ------------------- | ----------------------------------- |
| **Deployment type** | Self-hosted or CapivaSign Cloud      |
...
<Steps>
  ...
  <Step>
    ...
    - Email: [sales@capivapp.com.br](https://documen.so/enterprise)
  ...
  <Step>
    ...
    Options for evaluating CapivaSign before purchase:
  ...
  <Step>
    ...
    3. Deploy using [self-hosting guides](/docs/self-hosting) or access CapivaSign Cloud
...
<Accordions type="multiple">
  ...
  <Accordion title="Does the Enterprise license include CapivaSign Cloud?">
