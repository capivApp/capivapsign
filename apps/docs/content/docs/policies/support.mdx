...
Join the CapivaSign Discord server to:

- Ask questions and get help from the community
- Share feedback and feature requests
- Connect with other CapivaSign users
...
- **[GitHub Discussions](https://github.com/capivapp/capiva-sign/discussions)**: Ask questions, share ideas, and discuss features
- **[GitHub Issues](https://github.com/capivapp/capiva-sign/issues)**: Report confirmed bugs with reproducible steps

When opening an issue, include:

1. CapivaSign version
...
Paid plans include access to direct support from the CapivaSign team.
...
- Email support at support@capivapp.com.br
- Account and billing assistance
- Technical guidance for CapivaSign Cloud usage
...
- Private Discord channel for direct communication with the CapivaSign team
...
- [GitHub Discussions](https://github.com/capivapp/capiva-sign/discussions) - Community Q&A
...
- Guidance on CapivaSign features and functionality
...
For billing disputes or account issues, email support@capivapp.com.br with your account details.
...
<Steps>
  <Step>
    ...
    Email security@capivapp.com.br.
...
CapivaSign follows responsible disclosure practices. Security researchers who report valid vulnerabilities responsibly will be acknowledged.

## Contact

| Purpose          | Contact                                                        |
| ---------------- | -------------------------------------------------------------- |
| General support  | support@capivapp.com.br                                          |
| Security issues  | security@capivapp.com.br                                         |
| Enterprise sales | [sales@capivapp.com.br](https://documen.so/enterprise)           |
| Privacy requests | privacy@capivapp.com.br                                          |
| Community        | [Discord](https://documen.so/discord)                          |
| Bug reports      | [GitHub Issues](https://github.com/capivapp/capiva-sign/issues) |
...
- [Privacy Policy](/docs/policies/privacy) - How CapivaSign handles your data
