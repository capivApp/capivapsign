...
description: Learn how to set up OAuth providers for your own instance of CapivaSign.
---
...
- **Authorized JavaScript origins**: `https://<capivasign-domain>`
- **Authorized redirect URIs**: `https://<capivasign-domain>/api/auth/callback/google`

</Step>
<Step>
### Set environment variables

In your CapivaSign environment, set:
...
```bash
https://<capivasign-domain>/api/auth/callback/microsoft
```
