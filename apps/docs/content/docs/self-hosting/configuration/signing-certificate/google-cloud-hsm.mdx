...
Create a service account with the `cloudkms.signerVerifier` role so CapivaSign can use the key.

</Step>
<Step>
### Export public certificate

Export the public certificate from the HSM key; CapivaSign needs it to embed in signatures.
...
NEXT_PRIVATE_SIGNING_GCLOUD_HSM_KEY_PATH=projects/my-project/locations/global/keyRings/capivasign/cryptoKeys/signing-key/cryptoKeyVersions/1
NEXT_PRIVATE_SIGNING_GCLOUD_HSM_PUBLIC_CRT_FILE_PATH=/opt/capivasign/public.crt
