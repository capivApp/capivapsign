...
- **Create one automatically**: CapivaSign creates a new "Direct Link Recipient" for you

![Choose direct link recipient](/direct-links/choose-direct-link-recipient-capivasign.webp)
...
```
https://app.capivapp.com.br/d/<unique-token>
```

![Document direct link](/direct-links/document-direct-link-capivasign.webp)
...
If the recipient has a CapivaSign account with the email they entered, the document also appears in their Documents dashboard.
...
You can showcase templates with direct links on your public CapivaSign profile:
...
![CapivaSign profile with direct links](/direct-links/capivasign-profile.webp)
...
```html
<a href="https://app.capivapp.com.br/d/your-token">Sign our agreement</a>
```
