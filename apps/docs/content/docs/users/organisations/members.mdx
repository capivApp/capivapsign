...
Organisation ownership cannot be transferred through the regular organisation settings. Only a CapivaSign instance administrator can transfer ownership through the admin panel.

If you are using CapivaSign Cloud, contact support to request an ownership transfer. If you are self-hosting, an instance administrator can follow the steps below.
...
<Steps>
  ...
  <Step>
    Sign in or create a CapivaSign account.
  </Step>
  <Step>
