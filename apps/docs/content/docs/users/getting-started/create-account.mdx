...
description: Sign up for CapivaSign and configure your profile.
---
...
<img 
  src="/get-started-images/capivasign-registration-form.webp" 
  alt="CapivaSign registration form with name, email, and password fields"
...
Check your inbox for a verification email and click the confirmation link. The email is sent from `noreply@capivapp.com.br`.
...
<Steps>
  <Step>
    ...
    ![CapivaSign account security page showing security options](/get-started-images/capivasign-account-security-page.webp)
  ...
  <Step>
    ...
    ![Dialog to enable two-factor authentication with QR code setup](/get-started-images/capivasign-enable-2-factor-authentication.webp)
  ...
  <Step>
    ...
    ![Passkeys settings page showing registered passkeys](/get-started-images/capivasign-passkeys-page.webp)
  ...
  <Step>
    ...
    ![Dialog to add a new passkey with name input field](/get-started-images/capivasign-add-passkey-box.webp)
