...
```
docker run -d --restart=unless-stopped -p 3000:3000 -v capivasign:/app/data --name capivasign capivasign:latest
```
...
- `capivasign:latest` - Image you have built
...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/capivapp/capiva-sign)
