 ...
 * - Otherwise the CapivaSign logo is shown.
 */
export const TemplateBrandingLogo = ({ assetBaseUrl, className = 'mb-4 h-6' }: TemplateBrandingLogoProps) => {
  ...
  if (!hasCustomBrandingLogo) {
    const brandLogoUrl = new URL('/static/logo.png', assetBaseUrl).toString();

    return <Img src={brandLogoUrl} alt="CapivaSign Logo" className={className} />;
  }
