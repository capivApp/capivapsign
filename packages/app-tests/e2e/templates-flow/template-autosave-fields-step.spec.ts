...
test.describe('AutoSave Fields Step', () => {
  test('should autosave the fields without advanced settings', async ({ page }) => {
    ...
    await page.getByRole('option', { name: 'Recipient 2 (recipient2@capivapp.com.br)' }).click();
  ...
  test('should autosave the field deletion', async ({ page }) => {
    ...
    await page.getByRole('combobox').first().click();
    await page.getByRole('option', { name: 'Recipient 1 (recipient1@capivapp.com.br)' }).click();
