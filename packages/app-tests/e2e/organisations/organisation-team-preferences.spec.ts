...
test('[ORGANISATIONS]: manage branding preferences', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Brand Website' }).fill('https://capivasign.com');
  ...
  expect(teamSettings.brandingUrl).toEqual('https://capivasign.com');
  ...
  expect(inheritedTeamSettings.brandingUrl).toEqual('https://capivasign.com');
...
test('[ORGANISATIONS]: manage email preferences', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Reply to email' }).fill('organisation@capivapp.com.br');
  ...
  // Check that the team settings have inherited these values.
  expect(teamSettings.emailReplyTo).toEqual('organisation@capivapp.com.br');
  ...
  // Check that the team settings now inherit from organisation again.
  expect(inheritedTeamSettings.emailReplyTo).toEqual('organisation@capivapp.com.br');
  ...
  expect(documentMeta.emailReplyTo).toEqual('organisation@capivapp.com.br');
